...
if __name__ == "__main__":
    ...
    plot_comparison(
        ...
        filename="dropout_comparison_simplernn_kaggle.png"
    )
    ...
    plot_comparison(
        ...
        filename="class_weight_comparison_simplernn_kaggle.png"
    )
    ...
    plot_comparison(
        ...
        title=f"Experiment 3: Macro-F1 With vs Without Augmentation\n"
              ...
              f"stars = best epoch)",
        filename="augmentation_comparison_simplernn_kaggle.png"
    )
    ...
    result_simple = train_and_evaluate(
        train_texts, train_labels, test_texts, test_labels, vectorizer,
        dropout_rate=best_dropout, use_class_weights=use_weights_for_exp3,
        bidirectional=False, use_augmentation=use_augmentation_for_exp4, run_name="SimpleRNN"
    )
    result_bi = train_and_evaluate(
        train_texts, train_labels, test_texts, test_labels, vectorizer,
        dropout_rate=best_dropout, use_class_weights=use_weights_for_exp3,
        bidirectional=True, use_augmentation=use_augmentation_for_exp4, run_name="Bidirectional SimpleRNN"
    )
    ...
    plot_comparison(
        ...
        filename="simplernn_vs_bisimplernn_comparison_simplernn_kaggle.png"
    )

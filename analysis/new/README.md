...
============================================================
SimpleRNN (dropout, class weight, Augmentation, Bi-directional
============================================================
Dropout:

<img src="dropout_comparison_simplernn_twitter.png">

Class weight:

<img src="class_weight_comparison_simplernn_twitter.png">

Augmentation (depending on NLP)

<img src="augmentation_comparison_simplernn_twitter.png">
...
===========================================================
MENTION — Best BiGRU Hyperparameters Found
============================================================
...
============================================================
GRU (dropout, class weight, Augmentation, Bi-directional
============================================================
...
<img src="dropout_comparison_gru_twitter.png">

Class weight:

<img src="class_weight_comparison_gru_twitter.png">

Augmentation (depending on NLP)

<img src="augmentation_comparison_gru_twitter.png">

SimpleRNN vs BiSimpleRNN

<img src="gru_vs_bigru_comparison_gru_twitter.png">

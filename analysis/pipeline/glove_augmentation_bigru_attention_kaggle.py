...
HP = {
    ...
    "rnn_units": 32,           # best from hyperparameter sweep
...
if __name__ == "__main__":
    ...
    print(f"Negative F1: {per_class_f1[0]:.3f} | Neutral F1: {per_class_f1[1]:.3f} | "
          f"Positive F1: {per_class_f1[2]:.3f}")

...
HP = {
    # Values below are fixed from a prior hyperparameter search over:
...
def run_experiment(dropout_rate, train_texts, train_labels, test_texts, test_labels, vectorizer):
    ...
    print(f"Final (epoch {EPOCHS}) | test_acc={test_acc:.4f} test_f1={test_f1:.4f} combined={test_score:.4f}")
...
# ==================================================================
def plot_results(results, filename="bisimplernn_dropout_comparison_kaggle.png"):

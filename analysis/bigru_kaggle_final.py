#  BiGRU — Kaggle Financial Sentiment (all-data.csv)  (FINAL BEST CONFIG)
#
...
#
#  This script uses BiGRU (the architecture this file was built around),
#  with NO dropout — including no recurrent_dropout on the GRU layer,
#  since "no dropout" won across the board — class weights OFF, and
#  augmentation ON.
#
...
#  it turns out to be for this run (previously epoch 8).
...
# ==================================================================
# STEP 5: Build the Bidirectional GRU model (winning architecture, no dropout)
#
...
#
#   No Dropout / recurrent_dropout layer here — "no dropout" was the
#   winning setting from Exp 1.
# ==================================================================
...
print("\n" + "─" * 52)
print("CLASSIFICATION REPORT  (BiGRU + WordNet augmentation)")
print("─" * 52)

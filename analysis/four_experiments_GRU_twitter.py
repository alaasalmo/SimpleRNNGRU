...
if __name__ == "__main__":
    ...
    # ============================================================
    # EXPERIMENT 1: Dropout sweep (baseline GRU, no class weights)
    # ============================================================
    ...
    plot_comparison(
        ...
        filename="dropout_comparison_gru_twitter.png"
    )
    ...
    plot_comparison(
        ...
        filename="class_weight_comparison_gru_twitter.png"
    )
    ...
    plot_comparison(
        ...
        filename="augmentation_comparison_gru_twitter.png"
    )
    ...
    plot_comparison(
        ...
        filename="gru_vs_bigru_comparison_gru_twitter.png"
    )

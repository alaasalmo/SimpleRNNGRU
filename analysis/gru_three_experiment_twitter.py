"""
THREE EXPERIMENTS — GRU sentiment classifier
====================================================

1) Dropout: compare dropout=0.6 vs NO dropout (0.0), find best epoch for each, plot both.
2) Class weights: best dropout from (1), compare WITH vs WITHOUT class weights, plot both.
3) Architecture: compare GRU vs Bidirectional GRU (best settings from above), plot both.
...
if __name__ == "__main__":
    ...
    plot_comparison(
        arch_results,
        title=f"Experiment 3: GRU vs BiGRU\n(dropout={best_dropout}, "
              f"class_weights={'ON' if use_weights_for_exp3 else 'OFF'}, stars = best epoch)",
        filename="exp3_gru_vs_bigru_comparison.png"
    )
    ...
    print("  exp3_gru_vs_bigru_comparison.png")

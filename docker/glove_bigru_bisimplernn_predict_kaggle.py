...
# configs below share identical values, matching the training run
# (epoch 13, dropout 0.2, lr 0.0005, vocab 6000, rnn_units 32 for both).
MODEL_CONFIGS = {
    1: {
        "name": "BiSimpleRNN",
...
# Sort by epoch number embedded in the filename (ckpt_01, ckpt_02, ... ckpt_13)
...
# format (ckpt_13.index + ckpt_13.data-...) via ModelCheckpoint with
